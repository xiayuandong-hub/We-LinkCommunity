...
import co.yiiu.welink.config.realm.MyCredentialsMatcher;
import co.yiiu.welink.config.realm.MyShiroRealm;
...
//        map.put("/admin/user/**", "user");
    ...
    public CookieRememberMeManager rememberMeManager() {
        ...
        cookieRememberMeManager.setCipherKey(Base64.encode("We-Link is the best!".getBytes()));
