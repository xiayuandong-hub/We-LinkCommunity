...
import co.yiiu.welink.mapper.TopicMapper;
...
public class ElasticSearchPlugin {
    ...
    @Around("co.yiiu.welink.hook.TopicServiceHook.search()")
    ...
    @After("co.yiiu.welink.hook.IndexedServiceHook.indexAllTopic()")
    ...
    @After("co.yiiu.welink.hook.IndexedServiceHook.indexTopic()")
    ...
    @After("co.yiiu.welink.hook.IndexedServiceHook.deleteTopicIndex()")
    ...
    @After("co.yiiu.welink.hook.IndexedServiceHook.batchDeleteIndex()")
